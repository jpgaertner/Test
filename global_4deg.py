...
class GlobalFourDegreeSetup(VerosSetup):
    ...
    def set_parameter(self, state):
        ...
        state.var_meta.update(
            ...
            uWind= Variable("Zonal wind velocity", forc_dim, "m/s"),
            vWind= Variable("Meridional wind velocity", forc_dim, "m/s"),
        )
    ...
    def set_diagnostics(self, state):
        settings = state.settings
        state.diagnostics["snapshot"].output_frequency = 86400.0 * 10
        state.diagnostics['snapshot'].output_variables += ['hIceMean']
...
def set_forcing_kernel(state):
    ...
    def read_netcdf_forcing(var,file):
